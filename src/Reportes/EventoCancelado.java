 ...
 * @author Hector
 */
public class EventoCancelado extends JFrame{
       private int Ancho = 600, Alto = 600;
    
        public EventoCancelado(){
        setVisible(true);
        setSize(Ancho,Alto);
    ...
    private void elementos(JLabel fondo) {
        JLabel label = new JLabel("Ver Eventos Cancelados");
        ...
        ver.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                descripcion.setText(Login.MANEJOEVENTOS.listarEventoscancelados());   
                if(descripcion.getText().isBlank()){
                descripcion.setText("No hay ningun evento canceldo");
                }
            }
        });
