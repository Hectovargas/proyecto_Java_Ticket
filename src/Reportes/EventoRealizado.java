...
public class EventoRealizado extends JFrame{
    private int Ancho = 600, Alto = 600;
        public EventoRealizado(){
        setVisible(true);
        setSize(Ancho,Alto);
    ...
    private void elementos(JLabel fondo) {
        JLabel label = new JLabel("Ver Eventos Realizados");
        ...
        ver.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                descripcion.setText(Login.MANEJOEVENTOS.listarEventosPasados());   
                if(descripcion.getText().isBlank()){
                descripcion.setText("No hay ningun evento realizado");
                }
            }
        });
